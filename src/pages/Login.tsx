                    ...
                    <div className="text-center mb-8">
                        ...
                        <div className="flex flex-col items-center justify-center mb-2">
                            <div className="flex items-center gap-3 mb-1">
                                ...
                                <div className="text-lg font-bold tracking-wider uppercase text-left leading-tight">
                                    <span className="text-[var(--text-primary)]">Wired Wireless</span><br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-secondary)] to-[var(--color-primary)]">Automation Suite Platform</span>
                                </div>
                            </div>
                        </div>
                    </div>
